...
const bairro_entity_1 = require("../../localizacao/entities/bairro.entity");
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => pessoa_entity_1.Pessoa, (pessoa) => pessoa.enderecos, { onDelete: 'CASCADE' }),
    (0, typeorm_1.JoinColumn)({ name: 'idPessoa' }),
    __metadata("design:type", pessoa_entity_1.Pessoa)
], Endereco.prototype, "pessoa", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => bairro_entity_1.Bairro, (bairro) => bairro.enderecos),
